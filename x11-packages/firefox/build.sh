...
termux_step_configure() {
	...
	# /home/builder/.termux-build/firefox/src/memory/build/Mutex.h:75:38: error: use of undeclared identifier 'PTHREAD_MUTEX_ADAPTIVE_NP'; did you mean 'PTHREAD_MUTEX_RECURSIVE_NP'?
	...
	unset CXXFLAGS TARGET_CFLAGS LDFLAGS
